        ...
        <table class="form-table" role="presentation">
            <tbody>
                <tr class="example-class">
                    ...
                    <td>
                        <div class="example-class">
                            <input required="true" type="text" class="regular-text" id="helloprint_pitch_print_name" name="name" value="">
                        </div>
                    </td>
                </tr>
                ...
                <tr class="example-class">
                    ...
                    <td>
                        <div class="example-class">
                            <input required="true" type="text" class="regular-text" id="helloprint_pitch_print_design" name="design_id" value="">
                        </div>
                    </td>
                </tr>
                ...
                <tr class="example-class">
                    ...
                    <td>
                        <div class="example-class">
                            <input required="true" type="text" class="regular-text" id="helloprint_variant_key" name="variant_key" value="">
                        </div>
                    </td>
                </tr>
